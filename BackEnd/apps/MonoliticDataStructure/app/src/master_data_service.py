...
RESOURCES: dict[str, MasterDefinition] = {
    ...
    "knowledge-documents": MasterDefinition("public.knowledge_documents", ("title", "content", "source", "archivo", "expires_at", "is_active"), ("title", "content", "source"), boolean=("is_active",), nullable=("expires_at", "archivo")),
