...
def _database_name(default: str = "supply_chain") -> str:
    return _get_env("POSTGRES_DB_NAME", "DB_NAME", "POSTGRES_DB", "DB_POSTGRESDB_DATABASE", default=default)


def _get_postgres_connection_server(host: str = "postgres", db_name: str | None = None):
    resolved_host = _get_env("POSTGRES_HOST", "DB_HOST", "DB_POSTGRESDB_HOST", default=host)
    resolved_port = int(_get_env("POSTGRES_PORT", "DB_PORT", "DB_POSTGRESDB_PORT", default="5432"))
    resolved_db = db_name or _database_name()
    resolved_user = _get_env("POSTGRES_USER_NAME", "DB_USER", "POSTGRES_USER", "DB_POSTGRESDB_USER", default="admin")
    resolved_password = _get_env("POSTGRES_PASSWORD_VALUE", "DB_PASSWORD", "POSTGRES_PASSWORD", "DB_POSTGRESDB_PASSWORD", default="admin123")
