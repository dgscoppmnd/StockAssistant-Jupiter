...
export default function ProductCombobox({ products, selectedId, disabled, loading, onSelect }: Props) {
  const id = useId();
  ...
  return <div className="inventory-picker-combobox stock-order-product-combobox" onBlur={(event) => {
    ...
    <label className="input-label" htmlFor={id}>Producto (código o nombre)</label>
